...
let d = new Date() // Thu Apr 13 2023 15:38:12 GMT+0900 (한국 표준시)
d.getDate() // 1부터 시작. 날짜를 출력합니다.
d.getMonth() // 0월부터 시작. +1 필요
...
d.getFullYear()
// d.getYear() // 1900년도부터 연도 계산, 쓰지 않는다. 잊자!

// new Date(2023, 6, 30)
new Date(2023, 5, 30) // 6월을 표시하기 위해서는 -1을 해야한다. 월은 0부터 시작
new Date(2023, 5, 30, 18)

// 다음처럼 표현하면 가독성이 훨씬 좋다. 여기에서 문제가 발생! 왜 1이(2월) 아닌가??
new Date('2023/1/20/10:00:00')

today = new Date() // today의 지정 로캘(표준시간)은 KST다.
